...
"""Repository rule to generate host xcode_config and xcode_version targets.
   ...
   Note: this file is copied from Bazel 5.4.0, specifically from here:

   https://github.com/bazelbuild/bazel/blob/5.4.0/tools/osx/xcode_configure.bzl

   in order to enable building with Bazel 5 on Xcode 14.3 it was necessary to fix
   the Xcode locator compilation invocation from
   ...
   - https://bazelbuild.slack.com/archives/CD3QY5C2X/p1677700014558499
   - https://github.com/bazelbuild/bazel//commit/43dadb275b3f9690242bf2d94a0757c721d231a9
"""
